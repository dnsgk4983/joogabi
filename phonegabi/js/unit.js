$(function(){
    $('.unit-area > ul > li:nth-child(1)').click(function(){
        $('.unit-area > ul > li:nth-child(1) > img').attr('src','images/unit/icon1-1.png');
        ...
        $('.unit-area > ul > li:nth-child(4) > img').attr('src','images/unit/icon4.png');
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6.png');
        $('.unit-area > ul > li:nth-child(7) > img').attr('src','images/unit/icon7.png');
    ...
    $('.unit-area > ul > li:nth-child(2)').click(function(){
        ...
        $('.unit-area > ul > li:nth-child(2) > img').attr('src','images/unit/icon2-1.png');
        $('.unit-area > ul > li:nth-child(3) > img').attr('src','images/unit/icon3.png');
        $('.unit-area > ul > li:nth-child(4) > img').attr('src','images/unit/icon4.png');
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6.png');
    ...
    $('.unit-area > ul > li:nth-child(3)').click(function(){
        $('.unit-area > ul > li:nth-child(1) > img').attr('src','images/unit/icon1.png');
        $('.unit-area > ul > li:nth-child(2) > img').attr('src','images/unit/icon2.png');
        $('.unit-area > ul > li:nth-child(3) > img').attr('src','images/unit/icon3-1.png');
        $('.unit-area > ul > li:nth-child(4) > img').attr('src','images/unit/icon4.png');
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6.png');
        $('.unit-area > ul > li:nth-child(7) > img').attr('src','images/unit/icon7.png');
    ...
    $('.unit-area > ul > li:nth-child(4)').click(function(){
        ...
        $('.unit-area > ul > li:nth-child(2) > img').attr('src','images/unit/icon2.png');
        $('.unit-area > ul > li:nth-child(3) > img').attr('src','images/unit/icon3.png');
        $('.unit-area > ul > li:nth-child(4) > img').attr('src','images/unit/icon4-1.png');
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6.png');
        $('.unit-area > ul > li:nth-child(7) > img').attr('src','images/unit/icon7.png');
        $('.unit-area > ul > li:nth-child(8) > img').attr('src','images/unit/icon8.png');
    ...
    $('.unit-area > ul > li:nth-child(5)').click(function(){
        ...
        $('.unit-area > ul > li:nth-child(3) > img').attr('src','images/unit/icon3.png');
        $('.unit-area > ul > li:nth-child(4) > img').attr('src','images/unit/icon4.png');
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5-1.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6.png');
        $('.unit-area > ul > li:nth-child(7) > img').attr('src','images/unit/icon7.png');
        $('.unit-area > ul > li:nth-child(8) > img').attr('src','images/unit/icon8.png');
        $('.unit-area > ul > li:nth-child(9) > img').attr('src','images/unit/icon9.png');
    ...
    $('.unit-area > ul > li:nth-child(6)').click(function(){
        ...
        $('.unit-area > ul > li:nth-child(4) > img').attr('src','images/unit/icon4.png');
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6-1.png');
        $('.unit-area > ul > li:nth-child(7) > img').attr('src','images/unit/icon7.png');
        $('.unit-area > ul > li:nth-child(8) > img').attr('src','images/unit/icon8.png');
        $('.unit-area > ul > li:nth-child(9) > img').attr('src','images/unit/icon9.png');
    ...
    $('.unit-area > ul > li:nth-child(7)').click(function(){
        ...
        $('.unit-area > ul > li:nth-child(5) > img').attr('src','images/unit/icon5.png');
        $('.unit-area > ul > li:nth-child(6) > img').attr('src','images/unit/icon6.png');
        $('.unit-area > ul > li:nth-child(7) > img').attr('src','images/unit/icon7-1.png');
        $('.unit-area > ul > li:nth-child(8) > img').attr('src','images/unit/icon8.png');
        $('.unit-area > ul > li:nth-child(9) > img').attr('src','images/unit/icon9.png');
